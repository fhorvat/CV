...
tribble(
  ~with, ~what,
  "NGS data analysis", "differential expression analysis, ChIP-Seq, RIP-Seq, CNV, SNP, assembly, bioinformatics sequence analysis methods",
  "applied NGS data analysis", "Transcriptomics (RNA-seq, scRNA-seq)",
